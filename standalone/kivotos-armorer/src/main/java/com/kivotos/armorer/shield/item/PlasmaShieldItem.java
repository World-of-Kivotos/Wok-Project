package com.kivotos.armorer.shield.item;

import com.kivotos.armorer.ArmorerConfig;
import com.kivotos.armorer.shield.PlasmaShieldConfig;
import com.kivotos.armorer.shield.PlasmaShieldEquipmentMaterial;
import com.kivotos.armorer.shield.PlasmaShieldState;
import com.kivotos.armorer.shield.PlasmaShieldVariant;
import com.kivotos.armorer.shield.client.PlasmaShieldClientArmor;
...
public final class PlasmaShieldItem extends ArmorItem {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return "kivotos_armorer:textures/item/" + shieldVariant.itemId() + ".png";
    }
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        PlasmaShieldConfig.Stats stats = ArmorerConfig.PLASMA_SHIELD.stats(shieldVariant);
        PlasmaShieldState state = PlasmaShieldState.read(stack, stats);
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.type",
                        Component.translatable(shieldVariant.series().translationKey()))
                .withStyle(ChatFormatting.AQUA));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.tier",
                        Component.translatable(shieldVariant.tier().translationKey()))
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.shield",
                        decimal(state.shield()), decimal(stats.capacity()))
                .withStyle(ChatFormatting.BLUE));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.total_energy",
                        decimal(state.totalEnergy()), decimal(stats.maxTotalEnergy()))
                .withStyle(ChatFormatting.DARK_AQUA));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.heat",
                        decimal(state.heat()), decimal(stats.maxHeat()))
                .withStyle(state.overheated() ? ChatFormatting.RED : ChatFormatting.GOLD));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.heat_per_damage",
                        decimal(stats.heatPerDamage()))
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.cooling",
                        decimal(stats.coolingPerSecond()))
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.recharge",
                        decimal(stats.rechargePerSecond()), decimal(stats.rechargeDelayTicks() / 20.0D))
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.recharge_source")
                .withStyle(ChatFormatting.DARK_GRAY));
        if (stats.movementModifier() != 0.0D) {
            tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.movement",
                            signedPercent(stats.movementModifier()))
                    .withStyle(ChatFormatting.RED));
        }
        if (state.overheated()) {
            tooltip.add(Component.translatable("tooltip.kivotos_armorer.plasma_shield.shutdown")
                    .withStyle(ChatFormatting.RED));
        }
    }
