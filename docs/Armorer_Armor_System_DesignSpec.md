...
最终机动修正等于类型修正减去材料惩罚。第一版只修改基础移动速度；冲刺会继承同一移动属性倍率，但不另加冲刺、跳跃、换弹或瞄准专属修正。
...
|---|---:|---:|---:|---:|---:|---:|
| TacTec，超高分子聚乙烯 | 91.2% | 19% | 79.32% | 90.72 | +3% | 850 |
| Gladiator-S 轻型，陶瓷 | 90.6% | 34% | 78% | 96.6 | +2.5% | 420 |
...
| III | 8 | 52.319 | 57.444 | +9.453 |
| IV | 18 | 58.633 | 68.064 | +1.189 |
| V | 20 | 70.631 | 75.711 | +2.567 |
| VI | 5 | 78.109 | 81.098 | +2.398 |

最窄边界是 III 级最高的 6B23-1 装甲钢中甲 57.444 与 IV 级最低的 Strandhogg 铝制轻甲 58.633，仍保留 1.189 分。IV 级装甲钢重甲的抗穿为 34%，确实高于 V 级超高分子聚乙烯轻甲的 19%，但前者的综合分仍低于后者，符合“单项可跨、整体不跨”的规则。
