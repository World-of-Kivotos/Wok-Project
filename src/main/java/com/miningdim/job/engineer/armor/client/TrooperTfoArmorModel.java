...
public final class TrooperTfoArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            new ResourceLocation(MiningConstants.MODID, "plate_armor_trooper_tfo_multicam"), "main");
    ...
    private static CubeListBuilder createBody() {
        CubeListBuilder body = CubeListBuilder.create()
                ...
                .texOffs(100, 0)
                .addBox(-4.03F, 3.0F, -2.05F, 0.38F, 8.27F, 4.10F)
                .texOffs(100, 0)
                .addBox(3.65F, 3.0F, -2.05F, 0.38F, 8.27F, 4.10F)
                .texOffs(0, 22)
                ...
                .texOffs(75, 22)
                .addBox(-2.70F, 1.55F, -2.64F, 5.40F, 2.05F, 0.30F)
                .texOffs(0, 44)
                .addBox(-3.72F, 10.65F, -2.62F, 7.44F, 0.72F, 0.26F)
                .texOffs(0, 44)
                .addBox(-3.72F, 10.65F, 2.36F, 7.44F, 0.72F, 0.26F)
                .texOffs(25, 44)
                .addBox(-4.26F, 7.0F, -0.42F, 0.26F, 0.75F, 0.84F)
                .texOffs(25, 44)
                .addBox(4.0F, 7.0F, -0.42F, 0.26F, 0.75F, 0.84F)
                .texOffs(50, 44)
                .addBox(-0.12F, 4.98F, -2.61F, 0.24F, 5.55F, 0.22F)
                .texOffs(50, 44)
                .addBox(-0.12F, 4.98F, 2.39F, 0.24F, 5.55F, 0.22F);

        for (int row = 0; row < 3; row++) {
            body.texOffs(100, 22).addBox(-3.20F, 5.40F + row * 1.35F, -2.62F, 6.40F, 0.24F, 0.22F);
        }
        return body;
    }
}
