...
CUBES = {
    "carrier": CubeUV(0, 0, 7.50, 12.0, 4.0),
    "front_plate": CubeUV(26, 0, 7.30, 8.75, 0.58),
    "rear_plate": CubeUV(44, 0, 7.50, 9.45, 0.58),
    "left_side": CubeUV(63, 0, 0.50, 7.80, 4.80),
    "right_side": CubeUV(75, 0, 0.50, 7.80, 4.80),
    ...
    "left_pouch": CubeUV(50, 30, 1.76, 4.20, 3.00),
    "right_pouch": CubeUV(60, 30, 1.76, 4.20, 3.00),
    "admin_webbing": CubeUV(8, 80, 6.20, 0.26, 0.12),
    "front_buckle": CubeUV(24, 80, 0.70, 0.75, 0.18),
    "molle_loop": CubeUV(0, 80, 1.20, 0.24, 0.12),
    "right_shoulder_core": CubeUV(0, 48, 3.65, 4.75, 4.0),
    "left_shoulder_core": CubeUV(18, 48, 3.65, 4.75, 4.0),
    "right_shoulder_top": CubeUV(36, 48, 4.40, 0.52, 4.96),
    "left_shoulder_top": CubeUV(57, 48, 4.40, 0.52, 4.96),
    "right_shoulder_outer": CubeUV(78, 48, 0.46, 5.07, 4.86),
    "left_shoulder_outer": CubeUV(90, 48, 0.46, 5.07, 4.86),
    "right_shoulder_front": CubeUV(0, 60, 4.32, 4.70, 0.43),
    "left_shoulder_front": CubeUV(12, 60, 4.32, 4.70, 0.43),
    "right_shoulder_rear": CubeUV(24, 60, 4.32, 4.70, 0.43),
    "left_shoulder_rear": CubeUV(36, 60, 4.32, 4.70, 0.43),
}
