 ...
 * 转标准字)、转小写、去掉一切空格与符号, 然后按子串匹配。"管 理""Ａｄｍｉｎ""服★主"这类写法因此都能识破。有一类字
 * 本身算内容字符、看上去却只是一笔或一个记号 (长音符、单笔画汉字、重复记号, 见 {@link #SEPARATOR_LIKE_LETTERS}),
 * 夹在词中间起的也是分隔作用, 所以称号再去掉这些字比一次 ("管ー理""服一主""adーmin")。
 *
