...
public enum PlasmaShieldVariant {
    NANO_I(PlasmaShieldSeries.NANO, PlasmaShieldTier.I),
    ...
    STANDARD_I(PlasmaShieldSeries.STANDARD, PlasmaShieldTier.I),
    ...
    QUANTUM_I(PlasmaShieldSeries.QUANTUM, PlasmaShieldTier.I),
    ...
    public String translationKey() {
        return "item.kivotos_armorer." + itemId();
    }
