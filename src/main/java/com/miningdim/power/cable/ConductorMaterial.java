...
public enum ConductorMaterial implements CableProfile {
    ...
    //                    id                     额定FE  floor 绝缘                     耐压                    热学模式       线阻  可raw搓
    IRON(                "iron",                    256, 0.35, InsulationGrade.PVC,      VoltageClass.LOW,     ThermalMode.STANDARD, 961, true),
    ALUMINUM(            "aluminum",                768, 0.42, InsulationGrade.PVC,      VoltageClass.LOW,     ThermalMode.STANDARD, 265, true),
    COPPER(              "copper",                 1280, 0.45, InsulationGrade.PE,       VoltageClass.LOW,     ThermalMode.STANDARD, 168, true),
    TINNED_COPPER(       "tinned_copper",          1536, 0.45, InsulationGrade.PE,       VoltageClass.MEDIUM,  ThermalMode.STANDARD, 168, false),
    OFC_COPPER(          "ofc_copper",             2048, 0.46, InsulationGrade.EPR,      VoltageClass.MEDIUM,  ThermalMode.STANDARD, 166, false),
    OFE_COPPER(          "ofe_copper",             3072, 0.46, InsulationGrade.XLPE,     VoltageClass.MEDIUM,  ThermalMode.STANDARD, 165, false),
    SILVER_PLATED_COPPER("silver_plated_copper",   4096, 0.47, InsulationGrade.XLPE,     VoltageClass.HIGH,    ThermalMode.STANDARD, 160, false),
    GOLD(                "gold",                   3200, 0.50, InsulationGrade.XLPE,     VoltageClass.HIGH,    ThermalMode.STANDARD, 221, false),
    SILVER(              "silver",                 5120, 0.46, InsulationGrade.SILICONE, VoltageClass.HIGH,    ThermalMode.STANDARD, 159, false),
    GRAPHENE(            "graphene",               8192, 1.00, InsulationGrade.SILICONE, VoltageClass.EXTREME, ThermalMode.GRAPHENE, 80, false),
    NBTI_SUPERCONDUCTOR( "nbti_superconductor",   16384, 1.00, InsulationGrade.SILICONE, VoltageClass.EXTREME, ThermalMode.NBTI, 168, false),
    YBCO_SUPERCONDUCTOR( "ybco_superconductor",   32768, 1.00, InsulationGrade.SILICONE, VoltageClass.EXTREME, ThermalMode.YBCO, 1, false);
