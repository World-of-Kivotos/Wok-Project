package com.kivotos.armorer.armor.item;

import com.kivotos.armorer.ArmorerConfig;
import com.kivotos.armorer.armor.PlateArmorEquipmentMaterial;
import com.kivotos.armorer.armor.PlateArmorStats;
import com.kivotos.armorer.armor.PlateArmorVariant;
import com.kivotos.armorer.armor.client.PlateArmorClient;
...
public final class PlateArmorItem extends ArmorItem {
    ...
    private static final String MODEL_TEXTURE_PREFIX =
            "kivotos_armorer:textures/models/armor/plate_armor_";
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.level", variant.tier().name())
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.category",
                        Component.translatable("category.kivotos_armorer.plate_armor"))
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.type",
                        Component.translatable(variant.weight().translationKey()))
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.material",
                        Component.translatable(variant.material().translationKey()))
                .withStyle(ChatFormatting.GRAY));

        tooltip.add(Component.empty());
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.durability",
                        Math.max(0, stack.getMaxDamage() - stack.getDamageValue()), stack.getMaxDamage())
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.ballistic_r",
                        percent(stats.ballisticProtection()))
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.ballistic_q",
                        percent(stats.armorPiercingBuffer()))
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.general_g",
                        percent(stats.generalProtection()))
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.capacity_t",
                        decimal(stats.pressureCapacity()))
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.movement",
                        signedPercent(stats.movementModifier()))
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("tooltip.kivotos_armorer.plate_armor.replaces_vanilla")
                .withStyle(ChatFormatting.DARK_GRAY));
    }
