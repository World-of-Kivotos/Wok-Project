...
MODELS: dict[str, tuple[CubeUV, ...]] = {
    "b6b23": (
        ...
        CubeUV("left_bridge", 64, 20, 2.30, 1.0, 4.20, "webbing"),
        CubeUV("right_bridge", 79, 20, 2.30, 1.0, 4.20, "webbing"),
        ...
        CubeUV("right_arm_core", 0, 48, 4.10, 5.40, 4.10, "arm"),
        CubeUV("left_arm_core", 18, 48, 4.10, 5.40, 4.10, "arm"),
        CubeUV("right_arm_front", 36, 48, 5.0, 4.70, 0.45, "arm_panel"),
        CubeUV("left_arm_front", 48, 48, 5.0, 4.70, 0.45, "arm_panel"),
        CubeUV("right_arm_outer", 60, 48, 0.50, 4.60, 5.0, "arm_panel"),
        CubeUV("left_arm_outer", 72, 48, 0.50, 4.60, 5.0, "arm_panel"),
    ),
    "b6b5": (
        CubeUV("carrier", 0, 0, 8.0, 12.0, 4.0, "fabric"),
        ...
        CubeUV("right_shoulder", 0, 48, 4.40, 1.90, 4.20, "shoulder"),
        CubeUV("left_shoulder", 19, 48, 4.40, 1.90, 4.20, "shoulder"),
        CubeUV("right_shoulder_tab", 38, 48, 4.50, 1.80, 0.35, "shoulder"),
        CubeUV("left_shoulder_tab", 49, 48, 4.50, 1.80, 0.35, "shoulder"),
    ),
    "kirasa": (
        CubeUV("carrier", 0, 0, 8.0, 12.0, 4.0, "shell"),
        CubeUV("front_shell", 26, 0, 7.70, 10.80, 0.38, "shell"),
        CubeUV("rear_shell", 44, 0, 7.70, 10.80, 0.38, "shell"),
        CubeUV("left_side", 62, 0, 0.40, 10.0, 4.10, "side"),
        CubeUV("right_side", 73, 0, 0.40, 10.0, 4.10, "side"),
        CubeUV("front_collar", 0, 18, 5.80, 1.45, 0.50, "collar"),
        CubeUV("rear_collar", 14, 18, 5.80, 1.45, 0.50, "collar"),
        CubeUV("left_collar", 28, 18, 0.50, 1.50, 5.20, "collar"),
        CubeUV("right_collar", 41, 18, 0.50, 1.50, 5.20, "collar"),
        CubeUV("closure", 54, 18, 0.28, 8.90, 0.14, "seam"),
        CubeUV("chest_flap", 58, 18, 3.80, 2.0, 0.22, "flap"),
        CubeUV("bottom_hem", 68, 18, 8.10, 0.55, 0.22, "seam"),
    ),
    "kora": (
        CubeUV("carrier", 0, 0, 8.0, 12.0, 4.0, "fabric"),
...
DETAILS: dict[str, tuple[tuple[str, str, str], ...]] = {
    "b6b23": (
        ...
        ("left_bridge", "up", "webbing"),
        ("right_bridge", "up", "webbing"),
        ("lower_front", "north", "stitched"),
        ("groin", "north", "stitched"),
        ("groin", "south", "stitched"),
        ("waist_lip", "north", "webbing"),
        ("right_arm_core", "north", "channels"),
        ("left_arm_core", "north", "channels"),
        ("right_arm_front", "north", "channels"),
        ("left_arm_front", "north", "channels"),
        ("right_arm_outer", "west", "channels"),
        ("left_arm_outer", "east", "channels"),
    ),
    "b6b5": (
        ("carrier", "north", "stitched"),
        ("carrier", "south", "stitched"),
        ...
        ("right_shoulder_tab", "north", "webbing"),
        ("left_shoulder_tab", "north", "webbing"),
    ),
    "kirasa": (
        ("carrier", "north", "smooth"),
        ("carrier", "south", "smooth"),
        ("front_shell", "north", "smooth"),
        ("rear_shell", "south", "smooth"),
        ("left_side", "west", "smooth"),
        ("right_side", "east", "smooth"),
        ("front_collar", "north", "collar"),
        ("rear_collar", "south", "collar"),
        ("left_collar", "west", "collar"),
        ("right_collar", "east", "collar"),
...
THEMES = {
    "plate_armor_6b23_1_digital_flora_layer_1.png": {
        ...
        "palette": {
            ...
            "lower": (84, 97, 65, 255),
            "arm": (78, 91, 61, 255),
            "arm_panel": (72, 84, 56, 255),
        },
        "digital": {"fabric", "plate", "side", "collar", "lower", "arm", "arm_panel"},
        "edge": (48, 57, 40, 255),
...
EXPECTED_CUBES = {"b6b23": 20, "b6b5": 21, "kirasa": 12, "kora": 17}
